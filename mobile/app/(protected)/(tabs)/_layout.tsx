...
const TabIcon = memo(function TabIcon({
  ...
  switch (name) {
    ...
    case TabIconName.Call:
      icon = <PhoneOutgoing size={22} strokeWidth={1.75} color={tint} />;
      break;
  ...
  return (
    <View className="items-center gap-1">
      {icon}
      {focused && <View className="h-0.5 w-4 rounded-full bg-amber" />}
    </View>
  );
});
    ...
    >
      <Tabs.Screen
        ...
        options={{
          title: "Home",
          tabBarIcon: ({ focused }) => (
            <TabIcon name={TabIconName.Home} focused={focused} />
          ),
        }}
      />
      <Tabs.Screen
        ...
        options={{
          title: "Agents",
          tabBarIcon: ({ focused }) => (
            <TabIcon name={TabIconName.Agents} focused={focused} />
          ),
        }}
      />
      <Tabs.Screen
        ...
        options={{
          title: "Call",
          tabBarIcon: ({ focused }) => (
            <TabIcon name={TabIconName.Call} focused={focused} />
          ),
        }}
      />
      <Tabs.Screen
        ...
        options={{
          title: "Settings",
          tabBarIcon: ({ focused }) => (
            <TabIcon name={TabIconName.Settings} focused={focused} />
          ),
        }}
      />
    </Tabs>
