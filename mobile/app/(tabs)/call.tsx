...
import { View, Text, TextInput, SectionList, Pressable, ActivityIndicator } from "react-native";
  ...
  return (
    <SafeAreaView className="flex-1 bg-canvas" edges={["top"]}>
      ...
      <View className="px-5 pt-2 pb-2">
        <View className="flex-row items-center gap-2 rounded-xl border border-border bg-card px-3 h-10">
